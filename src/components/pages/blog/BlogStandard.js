...
import b_xl_1 from "../../../assets/images/blog/blog2img.png";
import b_xl_2 from "../../../assets/images/blog/blogteen.jpg";
                    ...
                    <div className="row">
                        <div className="col-lg-12 col-md-12 col-sm-12">
                            <div className="breadcrumb-wrap">
                                <h2>Cast the Magic Travel Blog</h2>
                                ...
                                <div className="col-lg-12 col-md-12 col-sm-12">
                                    <div className="blog-card-xl">
                                        ...
                                        <div className="blog-details">
                                            ...
                                            <Link to={`${process.env.PUBLIC_URL}/blog-details`} className="blog-title">Top 5 Tips for cruising with your Teen</Link>
                                            <p className="blog-discription">
                                            Ok so you decided to book your next family vacation sailing the high seas on a fabulous cruise
with your teen! And after reaching out to Cast The Magic Travel...(wink wink) together we have
found the perfect itinerary and ship for your family!
                                            </p>
                                            <div className="blog-btn">
                                                  <Link to={`${process.env.PUBLIC_URL}/blog-details1`} className="btn-common-sm">Read More</Link>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-lg-12 col-md-12 col-sm-12">
                                    <div className="blog-card-xl">
                                        ...
                                        <div className="blog-details">
                                            ...
                                            <Link to={`${process.env.PUBLIC_URL}/blog-details`} className="blog-title">Cruising with Teens</Link>
                                            <p className="blog-discription">
                                            Family vacations are just the best... Or at least they definitely have the potential to be!
                                            </p>
                                            <div className="blog-btn">
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-lg-12 col-md-12">
                                        <div className="blog-popular mt-40">
                                            <h5 className="categorie-head">Popular Posts</h5>
                                            <ul>
                                                <li className="blog-card-sm">
                                                    ...
                                                    <div className="blog-details-sm">
                                                        <Link to={`${process.env.PUBLIC_URL}/blog-details1`} className="blog-title-sm">Top 5 Tips for Cruising with Teens</Link>
                                                        <div className="blog-info">
                                                            <Link to={`#`} className="blog-writer"><i className="flaticon-user" />Holly Lee</Link>
                                                            <Link to={`#`} className="blog-date"> <i className="flaticon-calendar" />  26 January, 2023</Link>
                                                        </div>
                                                    </div>
                                                </li>
                                                <li className="blog-card-sm">
                                                    ...
                                                    <div className="blog-details-sm">
                                                        <Link to={`${process.env.PUBLIC_URL}/blog-details`} className="blog-title-sm">Cruising with Teens</Link>
                                                        <div className="blog-info">
                                                            <Link to={`#`} className="blog-writer"><i className="flaticon-user" />Holly Lee</Link>
